...
file_path = './xiaorong_for_GroupTC-BS/xiaorong_nature_graphs.xlsx'
df = pd.read_excel(file_path)

# Extract data for plotting
datasets = df['datasets']
o1 = df['speedup-opt1']
o1o2 = df['speedup-opt12']
o1o2o3 = df['speedup-opt123']
...
fig.legend(loc='upper right', bbox_to_anchor=(0.98, 0.95), ncol=4, fontsize=20)
...
# 保存图形为 PDF 文件
plt.savefig(r'D:\BaiduNetdiskDownload\xiaorong_bar_nature.pdf', format='pdf')
